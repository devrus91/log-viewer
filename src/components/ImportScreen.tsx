...
import { Activity, BookOpen, FileText, FileUp, FolderOpen, LockKeyhole, Search, ShieldCheck, Sigma, X, Zap } from "lucide-react";
...
export function ImportScreen() {
  ...
  return <main className="import-screen"><nav className="brand" aria-label="WOT Lab home"><WotLabBrand /></nav><Link className="import-docs-link" href="/docs"><BookOpen size={15} /> Documentation</Link><section className="import-card"><div className="import-kicker"><span>WORKSHOP-GRADE TELEMETRY</span><i /></div><h1>Every pull<br />tells a <em>story.</em></h1><p>Automotive log analysis, without the guesswork.</p><div className="import-capabilities" aria-label="Core capabilities"><span><Activity size={16} /><b>Synchronized</b><small>channels</small></span><span><Sigma size={16} /><b>Calculated</b><small>signals</small></span><span><ShieldCheck size={16} /><b>On-device</b><small>diagnostics</small></span></div>
